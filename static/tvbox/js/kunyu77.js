...
globalThis.getHeaders = function (input, ts) {
  ...
  let TK = md5(tkstr);
  let headers = {"User-Agent":"okhttp/3.12.0","TK":TK};
  return headers
}
...
var rule = {
  ...
  filter_url:'year={{fl.y}}&area={{fl.a}}',
  filter:{
    0:[
      {'key':'y','name':'年代','value':[{'n':'全部','v':''},
        {'n':'2023','v':'2023'},
        {'n':'2022','v':'2022'},
        {'n':'2021','v':'2021'},
        {'n':'2020','v':'2020'},
